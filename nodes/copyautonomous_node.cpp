...
int main(int argc, char* argv[])
{
   ...
   OutdoorBot::Navigation::ObstacleDetector OD_;
   
   while(nh.ok())
   {
   	double distance = 2.0, halfWidth = 0.65, wallAngle = 0.0;
   	if (OD_.obstacleInCone(distance, halfWidth, wallAngle)) cout << "object detected" << endl;
   	else cout << "object not detected " << endl;
