...
#define MAX_NUM_I2C_READINGS 12
  ...
  #define BRAKES_SPEED 85  // used both as a speed and also as an indicator for ROS to command pause
  #define BRAKES_APPLY_TIMER 2600
  #define BRAKES_RELEASE_TIMER 2000
  #define BRAKES_CURRENT_PIN A3
  #define BRAKES_CURRENT_APPLY_THRESHOLD 450
  #define BRAKES_CURRENT_RELEASE_THRESHOLD 530
  ...
  #define DAC_I2C_RIGHT 0x61
  #define DAC_I2C_LEFT 0x60
  ...
  #define MIN_ABSVAL_LINEAR_ROBOT_VELOCITY 300
  ...
  #define MAX_PID_ANGVEL_CHANGE_PER_CYCLE 2.0f // limit change to 2 deg/sec per cycle 
  #define MAX_PID_LINVEL_CHANGE_PER_CYCLE 10.0f // limit change to 10 mm/sec per cycle
...
#define RC_LINEAR_LIMITER 0.5                // reduces the forward and reverse speeds that max rc input can reach.  does not limit turning speeds
#define RC_ANGLULAR_LIMITER 0.5              // reduces the turning speeds that RC input can reach
